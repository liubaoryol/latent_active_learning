...
if __name__ == "__main__":
    ...
    # IL algorithm
    il, ppo = make_il(arg.algo, vec_env, rollouts, demo_batch_size=16)
    vec_env.seed(SEED)

    il.observation_space = il.gen_algo.observation_space
    il.action_space = il.gen_algo.action_space
    il.batch_size = il.gen_algo.batch_size
